...
in [`contracts/upto`](https://github.com/pedro-pelicioni/stellarsight/blob/main/contracts/upto) is measured the same way
([`upto-settlement-footprint.json`](https://github.com/pedro-pelicioni/stellarsight/blob/main/docs/status/upto-settlement-footprint.json)): 829,354
...
2. **The scheme implemented as standardized, and proven interoperable** (deliverable 2.2).
   The contract in [`contracts/upto`](https://github.com/pedro-pelicioni/stellarsight/blob/main/contracts/upto) already carries the negative-test
   ...
   ([`upto-settlement-deploy.json`](https://github.com/pedro-pelicioni/stellarsight/blob/main/docs/status/upto-settlement-deploy.json)). Still to do: the
