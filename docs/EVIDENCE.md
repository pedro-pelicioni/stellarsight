...
| `conformance` | 31 | `npm run verify:conformance` — an unmodified `@x402/fetch` client |
...
Written by `npm run verify:conformance -- --emit` on 2026-09-12 11:11:22 UTC
(commit `f147ad2`), driving an **unmodified `@x402/fetch` client** —
...
| ✓ an unmodified @x402/fetch client completes 402 -> sign -> settle -> 200 | HTTP 200 | `HTTP 200 in 6620ms` |
...
| ✓ the receipt carries a settled transaction hash | 64-hex transaction hash | `773663b16be4e8dbe6767a3cf6d99dbf3f9990e9b0e43f83e3156d6f9365fa1a` |

Settled: [`773663b16be4e8dbe6767a3cf6d99dbf3f9990e9b0e43f83e3156d6f9365fa1a`](https://stellar.expert/explorer/testnet/tx/773663b16be4e8dbe6767a3cf6d99dbf3f9990e9b0e43f83e3156d6f9365fa1a) · 0.01 SXT · 6620ms end to end.
...
|---|---|---|---|
| Instructions | 757,003 | 400,000,000 | 0.1893% |
...
Worst utilization **1.5%** — about 66.7× headroom against the tightest per-transaction limit. Measured on [`773663b16be4…`](https://stellar.expert/explorer/testnet/tx/773663b16be4e8dbe6767a3cf6d99dbf3f9990e9b0e43f83e3156d6f9365fa1a) in ledger 4,637,579.
...
|---|---|---|---|
| Balance | 19999.4602674 XLM | — | — |
| Runway | 6441553.83 days | < 7 days | ✅ ok |
| Last-hour burn vs 24h median | 23,039 vs 0 stroops | > 3× median and > 5,000,000 stroops floor | ✅ ok |
