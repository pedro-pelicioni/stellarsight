...
| `conformance` | 30 | `npm run verify:conformance` — an unmodified `@x402/fetch` client |
...
Written by `npm run verify:conformance -- --emit` on 2026-09-11 11:44:12 UTC
(commit `2f0116a`), driving an **unmodified `@x402/fetch` client** —
...
| ✓ an unmodified @x402/fetch client completes 402 -> sign -> settle -> 200 | HTTP 200 | `HTTP 200 in 7022ms` |
...
| ✓ the receipt carries a settled transaction hash | 64-hex transaction hash | `cae9fdb68b0c22a2e7dbcb9a725812bd93130ce8248a4df0eb6b73cf6313e7dc` |

Settled: [`cae9fdb68b0c22a2e7dbcb9a725812bd93130ce8248a4df0eb6b73cf6313e7dc`](https://stellar.expert/explorer/testnet/tx/cae9fdb68b0c22a2e7dbcb9a725812bd93130ce8248a4df0eb6b73cf6313e7dc) · 0.01 SXT · 7022ms end to end.
...
Worst utilization **1.5%** — about 66.7× headroom against the tightest per-transaction limit. Measured on [`cae9fdb68b0c…`](https://stellar.expert/explorer/testnet/tx/cae9fdb68b0c22a2e7dbcb9a725812bd93130ce8248a4df0eb6b73cf6313e7dc) in ledger 4,620,693.
...
|---|---|---|---|
| Balance | 19999.4625713 XLM | — | — |
| Runway | 6441554.57 days | < 7 days | ✅ ok |
| Last-hour burn vs 24h median | 38,685 vs 0 stroops | > 3× median and > 5,000,000 stroops floor | ✅ ok |
| Last conformance fee | 51,207 stroops | > 250,000 stroops | ✅ ok |
