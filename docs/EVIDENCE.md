...
| `conformance` | 27 | `npm run verify:conformance` — an unmodified `@x402/fetch` client |
...
Written by `npm run verify:conformance -- --emit` on 2026-09-08 11:40:13 UTC
(commit `60deb48`), driving an **unmodified `@x402/fetch` client** —
...
| ✓ an unmodified @x402/fetch client completes 402 -> sign -> settle -> 200 | HTTP 200 | `HTTP 200 in 6725ms` |
...
| ✓ the receipt carries a settled transaction hash | 64-hex transaction hash | `3be4e366cd9c158bf52d5d1afa01f7605f56d542597773d4700cec7f872a47c0` |

Settled: [`3be4e366cd9c158bf52d5d1afa01f7605f56d542597773d4700cec7f872a47c0`](https://stellar.expert/explorer/testnet/tx/3be4e366cd9c158bf52d5d1afa01f7605f56d542597773d4700cec7f872a47c0) · 0.01 SXT · 6725ms end to end.
...
Worst utilization **1.5%** — about 66.7× headroom against the tightest per-transaction limit. Measured on [`3be4e366cd9c…`](https://stellar.expert/explorer/testnet/tx/3be4e366cd9c158bf52d5d1afa01f7605f56d542597773d4700cec7f872a47c0) in ledger 4,568,805.
...
|---|---|---|---|
| Balance | 19999.4725800 XLM | — | — |
| Runway | 5830847.16 days | < 7 days | ✅ ok |
