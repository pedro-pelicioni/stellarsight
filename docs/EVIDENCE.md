...
| `conformance` | 25 | `npm run verify:conformance` — an unmodified `@x402/fetch` client |
...
Written by `npm run verify:conformance -- --emit` on 2026-09-06 11:17:17 UTC
(commit `05d814a`), driving an **unmodified `@x402/fetch` client** —
...
| ✓ an unmodified @x402/fetch client completes 402 -> sign -> settle -> 200 | HTTP 200 | `HTTP 200 in 6467ms` |
...
| ✓ the receipt carries a settled transaction hash | 64-hex transaction hash | `a6911ab897823b6476c430c64002fd8436d33ac93e09d3ca40f5241dc27c617d` |

Settled: [`a6911ab897823b6476c430c64002fd8436d33ac93e09d3ca40f5241dc27c617d`](https://stellar.expert/explorer/testnet/tx/a6911ab897823b6476c430c64002fd8436d33ac93e09d3ca40f5241dc27c617d) · 0.01 SXT · 6467ms end to end.
...
Worst utilization **1.5%** — about 66.7× headroom against the tightest per-transaction limit. Measured on [`a6911ab89782…`](https://stellar.expert/explorer/testnet/tx/a6911ab897823b6476c430c64002fd8436d33ac93e09d3ca40f5241dc27c617d) in ledger 4,533,970.
...
|---|---|---|---|
| Balance | 19999.4781436 XLM | — | — |
| Runway | 5511081.38 days | < 7 days | ✅ ok |
| Last-hour burn vs 24h median | 38,571 vs 0 stroops | > 3× median and > 5,000,000 stroops floor | ✅ ok |
| Last conformance fee | 51,077 stroops | > 250,000 stroops | ✅ ok |
