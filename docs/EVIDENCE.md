...
| `conformance` | 34 | `npm run verify:conformance` — an unmodified `@x402/fetch` client |
...
Written by `npm run verify:conformance -- --emit` on 2026-09-15 12:01:52 UTC
(commit `c3ed040`), driving an **unmodified `@x402/fetch` client** —
...
| ✓ an unmodified @x402/fetch client completes 402 -> sign -> settle -> 200 | HTTP 200 | `HTTP 200 in 6924ms` |
...
| ✓ the receipt carries a settled transaction hash | 64-hex transaction hash | `aa16e6bc91605c0481c509ab70665c0b1e828e81b6b637021fe8d5f83f90d779` |

Settled: [`aa16e6bc91605c0481c509ab70665c0b1e828e81b6b637021fe8d5f83f90d779`](https://stellar.expert/explorer/testnet/tx/aa16e6bc91605c0481c509ab70665c0b1e828e81b6b637021fe8d5f83f90d779) · 0.01 SXT · 6924ms end to end.
...
Worst utilization **1.5%** — about 66.7× headroom against the tightest per-transaction limit. Measured on [`aa16e6bc9160…`](https://stellar.expert/explorer/testnet/tx/aa16e6bc91605c0481c509ab70665c0b1e828e81b6b637021fe8d5f83f90d779) in ledger 4,690,025.
...
|---|---|---|---|
| Balance | 19999.4508390 XLM | — | — |
| Runway | 6439269.39 days | < 7 days | ✅ ok |
