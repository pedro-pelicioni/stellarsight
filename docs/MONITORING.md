...
| Fee burn rate | balance delta per hour | > 3× the trailing 24h median | Possible drain attempt — inspect payer dispersion, consider rate limits | ✅ measured nightly, alerted every 6h |
