...
problem. There is separate ecosystem-level work funded to solve trustline onboarding
properly, and when it lands the right move is to route buyers to it rather than to keep
growing a faucet. Nothing in the payment path assumes our version.
