# Deploying STELLARSIGHT — the operator path
...
exact steps, which is what makes the [self-hosting argument](ARCHITECTURE.md#93-self-hosting)
checkable rather than rhetorical.

The other two paths: a seller wiring a paid API into an existing facilitator wants the
[seller quickstart](QUICKSTART-SELLER.md); a buyer or agent wants the
[agent and MCP guide](../apps/agent/README.md).
